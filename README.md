![CI for radarin](https://github.com/arquisoft/radarin_en2b/workflows/CI%20for%20radarin/badge.svg)
...
Link to the deployed sample application: [radarin0](https://radarinen2bwebapp.herokuapp.com/). Note that sometimes **it can take a while to load** because Heroku in the free plan, takes the containers to sleep when they are not used for some time and taking them up takes time.
