    ...
    <div class="bgcenter">
        <>
            <Alert show={show}>
                ...
                <p>
                    In order to create chats in Radarin, you will have to click <span style={{ color: "blue" }} onClick={() => window.open(webId + "inbox/", '_blank')}>here</span>. This will open a new tab, the inbox of your Pod. Radarin
            ...
            give everyone a 'Poster' access (if you do not know how to do this click <span>here</span> to see a tutorial). Now, you also have to create the chat in the inox folder and publish a chat (in the same <span>link</span> as before you will fins a tutorial).
          </p>
                <p>
