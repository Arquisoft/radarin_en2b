...
class AdminManageUsers extends Simulation {
	...
	val scn = scenario("AdminManageUsers")
		.exec(http("request_0")
			.get("/?code=f38a307864e034d9bef76829d33d2466&state=862a311cf2554a8aa6f9b354c7ec6f00")
			.headers(headers_0))
		.pause(2)
		.exec(http("request_1")
			.post(uri1 + "?key=AIzaSyB2h2OuRcUgy5N-5hsZqiPW6sH3n_rptiQ")
			.headers(headers_1)
			.body(RawFileBody("/adminmanageusers/0001_request.json")))
		.pause(2)
		.exec(http("request_2")
		...
		.exec(http("request_3")
			...
			.post(uri3 + "/add")
			.headers(headers_4)
			.body(RawFileBody("/adminmanageusers/0004_request.json")),
            http("request_5")
			...
			.post(uri3 + "/getById")
			.headers(headers_6)
			.body(RawFileBody("/adminmanageusers/0006_request.json")),
            http("request_7")
			...
			.headers(headers_8)
			.body(RawFileBody("/adminmanageusers/0008_request.json"))))
