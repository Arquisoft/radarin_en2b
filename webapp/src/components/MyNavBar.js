                ...
                <Navbar variant="dark" expand="lg" collapseOnSelect>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="mr-auto justify-content-center container-fluid" fill>
                            <Link to="/" className="otherLink" style={{"padding":"1em"}}>
                                <Navbar.Brand>
                                    Radarin
                                </Navbar.Brand>
                            </Link>
                            <Nav className="">
                                {(() => {
                                    if (role === null || role !== "Admin") {
                                        return (
                                            <React.Fragment>
                                                <Link data-testid="link-friend-list" to="/friendList" style={{"text-align": "center"}}>
                                                    <Navbar.Brand style={{"margin-right": "0em"}}>
                                                ...
                                                <Link data-testid="link-map" to="/map" style={{"text-align": "center"}}>
                                                    <Navbar.Brand style={{"margin-right": "0em"}}>
