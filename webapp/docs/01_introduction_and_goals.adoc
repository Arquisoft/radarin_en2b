...
| Two software components (at least) taken into account | A web application and an application that will run in users' mobile phone.
...
| Application runed in users' mobile phone | It will send the corresponding locations to the server.
