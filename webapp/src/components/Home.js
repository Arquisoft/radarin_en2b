    ...
    return (
        ...
        <Carousel.Item interval={7000}>
            ...
            <div class="gradient-border"><Carousel.Caption>
                <div><img src={solid} class="item" alt="solid"></img><img src={inrupt} class="item" alt="inrupt"></img></div>
            ...
            <div class="gradient-border">
                <Carousel.Caption>
                <img src={map} class="item" alt="map"></img>
                <br></br>
            ...
            <div class="gradient-border">
                <Carousel.Caption>
                <img src={friends} class="item" alt="friends"></img>
            ...
            <div class="gradient-border">
                <Carousel.Caption>
                <img src={noti} class="item" alt="notifications"></img>
            ...
            <div class="gradient-border">
                <Carousel.Caption>
                <img src={location} class="item" alt="location"></img>
